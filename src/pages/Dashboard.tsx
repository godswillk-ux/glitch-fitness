...
export const Dashboard = () => {
  ...
  const handleAdminSettingsUpdate = async (e: React.FormEvent) => {
    e.preventDefault();
    await updateSettings({ backgroundImageUrl: bgUrl, backgroundTheme: bgTheme as 'default' | 'gold' });
  };
                        ...
                        <div className="space-y-2">
                          ...
                          {bgPreview ? (
                            ...
                            >
                              ...
                              <p className="text-xs font-medium">Click to upload background</p>
                            </div>
                          )}
                          <input 
                            type="file" 
                          ...
                          <div className="space-y-2 pt-2">
                            <Label htmlFor="bgUrl" className="text-xs">Or Image URL</Label>
                            <Input 
                              id="bgUrl" 
                              value={bgUrl} 
                              onChange={(e) => {
